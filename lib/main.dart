...
bool _effectivePlayerBuffering(Map<String, dynamic> player) {
  ...
  final song = _asMap(player['currentSong']);
  final hasSong = (song?['videoId']?.toString().isNotEmpty ?? false);
  return hasSong && !playing && position <= 0;
}
        ...
        slivers: [
          ...
          if (_loading)
            ...
            if (_visibleSectionCount < feedSections.length)
              const SliverToBoxAdapter(child: _HomeFeedLoadingMore()),
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                ...
                _FoxyBrandPalette.foxDeep.withValues(alpha: 0.65),
...
class _SettingsSheetState extends State<_SettingsSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final wifiTier = _int('wifiQualityTier', -1).clamp(-1, 4);
    final mobileTier = _int('mobileQualityTier', -1).clamp(-1, 4);
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: switch (_settingsPage) {
                      ...
                      _FoxySettingsPage.advanced => _buildAdvancedSettings(
                        ...
                        recognitionHistoryLimit: recognitionHistoryLimit,
                      ),
  ...
  Widget _buildPlaybackSettings(
    ...
    required int wifiTier,
    required int mobileTier,
    ...
    return ListView(
      ...
      children: [
        ...
        _SettingsCard(
          title: 'Network quality profiles',
          subtitle:
              'Optional overrides. Follow default keeps the main stream quality.',
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _qualityOverrideChips(
                title: 'Wi-Fi',
                value: wifiTier,
                onChanged: (v) => _apply({'wifiQualityTier': v}),
              ),
              const SizedBox(height: 14),
              _qualityOverrideChips(
                title: 'Mobile data',
                value: mobileTier,
                onChanged: (v) => _apply({'mobileQualityTier': v}),
              ),
            ],
          ),
        ),
        ...
        _SettingsPlannedCard(
          ...
          items: const [
            ...
            'Per-network quality profiles for Wi-Fi and mobile data',
